...
<div id="auto-register">
	<fieldset class="form-vertical">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" size="20" id="payplansRegisterAutoName" name="payplansRegisterAutoName" class="required"/>
				<span class="payplansRegisterAutoName">
				...
				<div class="text-warning pp-gap-bottom05" id="err-payplansRegisterAutoName"></div>
			</div>	
		</div>	
		...
		<div class="control-group">
			<div class="offset8">
				<button type="submit" class="btn" id="payplansRegisterNewauto" name="payplansRegisterNewauto"><i class="icon-user"></i>&nbsp;<?php echo XiText::_('COM_PAYPLANS_PLAN_REGISTER_AUTO')?></button>
			</div>
		</div>
	</fieldset>
</div>

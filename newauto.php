 ...
 * @subpackage	Plugin
 */
class  plgPayplansregistrationNewAuto extends XiPluginRegistration
{
	...
	protected function _doStartRegistration()
	{
		...
		$name 	  = JRequest::getVar('payplansRegisterAutoName', false);
		...
		$userId = $this->_autoRegister($username, $email, $password, $name);
	...
	function _autoRegister($username, $email, $password, $name)
	{
		return $this->_autoRegister16($username, $email, $password, $name);
	}
	
	function _autoRegister16($username, $email, $password, $name)
	{
...
//		$password = JUserHelper::genRandomPassword();
		$temp = array(	'username'=>$username,'name'=>$name,'email1'=>$email,
